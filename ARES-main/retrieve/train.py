...
def main(args):
    ...
    config_file = args.config or f'configs/retriever/{args.dataset}.yaml'
    ...
    if args.name_suffix:
        exp_prefix = f"{exp_prefix}_{args.name_suffix}"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name_suffix', type=str, default=None,
                        help='Optional suffix appended to run name prefix')
