...
DEFAULT_CONFIG_NAME="webqsp_retriever_grpo"
...
TRAINER_DEFAULT_LOCAL_DIR="${TRAINER_DEFAULT_LOCAL_DIR:-${CHECKPOINT_ROOT}/webqsp/retriever_grpo/qwen3-4b-grpo}"
...
export WANDB_PROJECT="${WANDB_PROJECT:-webqsp_retriever_grpo}"
export WANDB_NAME="${WANDB_NAME:-qwen3_4b_grpo_webqsp}"
...
export WEBQSP_REMOTE_ANSWER_URL="${WEBQSP_REMOTE_ANSWER_URL:-http://10.87.135.152:8004/answer}"
